...
#define SOURCES_LIST_FILENAME "sources.txt"
...
void Update_Source(source_data *s)
{
    ...
    */
	if (s->type == type_url)
    {
        Com_Printf("Update Source from URL Not supported yet");
...
void Reload_Sources(void)
{
    ...
    FILE*f = fopen(SOURCES_LIST_FILENAME, "rb");
	if (!f) 
	{
